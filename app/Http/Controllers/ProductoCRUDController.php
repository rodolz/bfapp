...
class ProductoCRUDController extends Controller
{
    ...
    public function getdata(){
        ...
        return Datatables::of($productos)
                            ...
                            <a class='btn btn-orange' href='productos/{$producto->id}'><i class='fas fa-eye' aria-hidden='true'></i></a>
                            <a class='btn btn-info' href='productos/{$producto->id}/edit'><i class='fas fa-edit' aria-hidden='true'></i></a>
