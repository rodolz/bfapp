                    ...
                    <table class="rwd-table">
                        ...
                        @if(count($facturas) > 0)
                            ...
                            <tr>
                                ...
                                <td colspan="3"></td>
                                <td><h4 class="bold" style='margin:0px;' class="text-info">${{number_format($total_30dias,2,'.',',')}}</h4></td>
                                <td><h4 class="bold" style='margin:0px;' class="text-warning">${{number_format($total_60dias,2,'.',',') }}</h4></td>
                                <td><h4 class="bold" style='margin:0px;' class="text-danger">${{number_format($total_90dias,2,'.',',') }}</h4></td>
                            </tr>
                            @else
                                <tr>
                                    <td colspan="7">
